...
const SCREENS = [
  ...
  ['me', '/me', 'حسابي وأجهزتي', 'الساكن'],
  ['map', '/map', 'خريطة القرية', 'الأرشيف'],
  ['building', '/buildings/one', 'صفحة عمارة', 'الأرشيف'],
  ['help', '/help', 'محتاج مساعدة', 'الأرشيف'],
  ['home-admin', '/admin', 'رئيسية المجلس', 'الإدارة'],
  ...
  ['fees', '/admin/fees', 'الاشتراكات والمستحقات', 'الإدارة'],
  ['settlements', '/admin/settlements', 'التسويات وأرصدة الملّاك', 'الإدارة'],
  ['members', '/admin/members', 'الأعضاء والتفعيل', 'الإدارة'],
  ['import', '/admin/import', 'استيراد سجل الملّاك', 'الإدارة'],
  ['recoveries', '/admin/recoveries', 'الاستعادة والتفعيل', 'الإدارة'],
  ['publish', '/admin/content', 'نشر خبر أو قرار', 'الإدارة'],
  ['adminmap', '/admin/map', 'إدارة الخريطة', 'الإدارة'],
  ['ledger', '/admin/ledger', 'دفتر القيود', 'الرقابة'],
  ['audit', '/admin/audit', 'سجل التغييرات', 'الرقابة'],
  ['categories', '/admin/categories', 'بنود الإيرادات والمصروفات', 'الرقابة'],
  ['users', '/admin/users', 'الأدوار والصلاحيات', 'الرقابة'],
  ['staff', '/admin/staff', 'الموظفين والمرتبات', 'الرقابة'],
  ['settings', '/admin/settings', 'إعدادات القرية', 'الرقابة'],
  ['health', '/admin/health', 'صحة النظام والحصص', 'الرقابة'],
...
const ROUTE_PATTERNS = [
  ...
  ['^/map', 'map'],
  ['^/help', 'help'],
  // Longest-prefix first: `/admin/map` must not be eaten by `/admin/m…`, and
  // `/admin/members` must not be eaten by `/admin/me`. The list is scanned in
  // order, so the order IS the rule.
  ['^/admin/review', 'review'],
  ['^/admin/payments', 'approved'],
  ['^/admin/expenses', 'expenses'],
  ['^/admin/fees', 'fees'],
  ['^/admin/settlements', 'settlements'],
  ['^/admin/periods', 'settlements'],
